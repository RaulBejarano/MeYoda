    ...
    <div class="sidebar">
        ...
        <div id="yoda_image">
          ...
          <ul class="navi">
            ...
            <li class="nred current sectionLi" data-section="home"><a href="#"><i class="icon-home icon-white"></i> Inicio</a></li>
            ...
            <li class="has_submenu nlightblue ">
              ...
              <ul>
                <li class="sectionLi" data-section="vendidas"><a href="#">Vendidas</a></li>
                <li class="sectionLi" data-section="enventa"><a href="#">En Venta</a></li>
              </ul>
            </li>

            <li class="ngreen sectionLi" data-section="mispujas"><a href="#"><i class="icon-white icon-briefcase"></i> Mis Pujas</a></li>
...
<!--             <li class="norange"><a href="#"><i class="icon-sitemap"></i> UI Elements</a></li>
 ...
 -->
    ...
    <div class="mainbar">
      ...
      <div class="page-head">
        <!-- Page heading -->
        <h2 id="sectionTitle" class="pull-left">Dashboard 
          <!-- page meta -->
<!--           <span class="page-meta">Something Goes Here</span>
 -->        </h2>
        ...
        <!-- Breadcrumb -->
        <div id="breadcrumbs" class="hide bread-crumb pull-right">
          <a href="index.html"><i class="icon-home"></i> Mi Mazo</a> 
          <!-- Divider -->
          <span class="divider">/</span> 
          <a href="#" class="bread-current" id="mazosection">Dashboard</a>
        </div>
